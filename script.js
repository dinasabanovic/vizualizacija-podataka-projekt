(function (d3, topojson) {
    ...
    Promise.all([
      ...
      //https://soshace.com/mapping-the-world-creating-beautiful-maps-and-populating-them-with-data-using-d3-js/
      //https://github.com/d3/d3-geo/blob/main/README.md#cylindrical-projections
    ...
    function updateCharts(chosenChartCategory) {
        ...
        //https://www.tutorialsteacher.com/d3js/create-pie-chart-using-d3js?utm_content=cmp-true
        ...
        //5https://d3-graph-gallery.com/graph/density_basic.html
